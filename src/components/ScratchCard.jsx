...
export default function ScratchCard() {
  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      ...
      >
        {/* Hidden date layer */}
        <div className="absolute inset-0 flex items-center justify-center gap-6 bg-gradient-to-br from-deepBlue to-[#0F274D]">
          <div className="text-center">
            <p className="font-serif text-4xl text-skyBlue leading-none">24</p>
          </div>
          <div className="text-center border-x border-skyBlue/40 px-6">
            <p className="font-sans tracking-[0.2em] text-white text-sm">SEPTEMBER</p>
          </div>
          <div className="text-center">
            <p className="font-serif text-4xl text-skyBlue leading-none">2026</p>
          </div>
        </div>
